...
class ClassifierManager:
    ...
    def load_data(self, should_log):
        ...
        self._input_df = pd.DataFrame(wine.data, columns=[col for col in list(wine.feature_names)])
        self._input_df['TARGET'] = [self._FEATURE_NAMES[idx] for idx in list(wine.target)]
